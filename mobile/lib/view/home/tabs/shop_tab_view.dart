...
Padding(
  ...
  child: Column(
    children: [
      ...
      const SizedBox(
        width: 100,
        child: Padding(
          padding: EdgeInsets.symmetric(vertical: 5), // Adjust this to reduce space
          child: Divider(
            color: AppColors.black,
            height: 0,
            thickness: 3,
  ...
  gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
    ...
    childAspectRatio: 0.75, // Adjust to control the aspect ratio of grid items
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Padding(
              padding: const EdgeInsets.all(8.0), // Reduced padding around the image
              child: ClipRRect(
                borderRadius: BorderRadius.circular(10.0),
                child: Image.network(
                  'http://localhost:4000/upload/images/${product.image[0]}',
                  height: 200, // Height of the image
                  width: double.infinity, // Width takes the full container width
        ...
        child: _searchQuery.isEmpty
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      ...
                      style: TextStyle(color: Colors.grey), // Optional: Set color
                    ),
                  ],
                ),
              )
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    margin: const EdgeInsets.symmetric(vertical: 4.0, horizontal: 8.0), // Margin around the card
                    elevation: 2, // Optional: Shadow effect
                    child: ListTile(
                      contentPadding: const EdgeInsets.all(8.0), // Optional: Padding inside ListTile
                      leading: ClipRRect(
